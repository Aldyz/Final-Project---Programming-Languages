...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initialize(){
        ...
        btnMainLogin.addActionListener(new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e) {
                formLogin.setVisible(true);
                formLogin.setLocationRelativeTo(null);
                formLogin.setTitle("Login Form");
            }
        });
        //Java Functional Programing
        /*btnMainLogin.addActionListener((ActionEvent e) -> {
            formLogin.setVisible(true);
            formLogin.setLocationRelativeTo(null);
        });*/
    }
    ...
    public static void main(String args[]) {
        ...
        try {/*
            ...
            //Class.forName("liquidlnf.com.birosoft.liquid");
